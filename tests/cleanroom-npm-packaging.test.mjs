...
test("four target builds produce five verified npm tarballs and the installed meta package selects the host", { timeout: 360_000 }, async t => {
  ...
  const metaTarball = path.join(tarballRoot, "glide-the-ink-claude-code-dream-0.1.0.tgz");
  const hostTarball = path.join(tarballRoot, `glide-the-ink-claude-code-dream-${hostTarget}-0.1.0.tgz`);
