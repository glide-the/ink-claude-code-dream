...
function validateManifest(value) {
  ...
  if (manifest.schemaVersion !== "ink-claude-cli-envelope/v1" || manifest.runtime?.integration.environment !== "CLAUDE_CODE_CLI_PATH" || manifest.runtime.integration.sdkOption !== "ClaudeAgentOptions.cli_path" || manifest.runtime.integration.sdkModified !== false || manifest.core?.delivery !== "external-not-bundled" || manifest.core.loadingReduction !== 0 || manifest.protocol?.name !== "claude-code-stream-json" || manifest.protocol?.version !== 1 || !Array.isArray(manifest.mcpVersionsRegressed) || !manifest.mcpVersionsRegressed.every((value2) => typeof value2 === "string")) {
