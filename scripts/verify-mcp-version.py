...
[Sync] 2026-09-15: pair MCP matrix evidence with Runtime 0.1.10 diagnostics.
"""
...
INITIALIZE = {
    ...
    "capabilities": {},
    "clientInfo": {"name": "ink-runtime-matrix", "version": "0.1.10"},
}


def server() -> Server:
    instance = Server("ink-matrix", version="0.1.10")
    tools = [
...
async def exercise(expected: str) -> dict[str, object]:
    ...
    if actual_sdk != "0.2.145" or actual_mcp != expected or MCP_MAJOR != 1:
