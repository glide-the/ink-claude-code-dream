...
Both src trees must have identical complete directory lists, module paths, bytes and
modes. The original 1,902 files/35 module directories remain intact; added empty
...
Current results are in [0.1.8 notes](../build/runtime-0.1.8-release-notes.md).
Old immutable acceptance receipts cannot qualify current bytes. This turn does not
publish, deploy, use production data or alter API/database/ZIP contracts.
